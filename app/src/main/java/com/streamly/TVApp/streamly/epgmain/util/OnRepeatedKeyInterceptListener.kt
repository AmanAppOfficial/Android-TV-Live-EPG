package com.streamly.TVApp.streamly.util
...
//            Log.e("OnRepeatedKey", "::>>>>if (!= KEYCODE_DPAD_UP && != KEYCODE_DPAD_DOWN)...")
            return false
        } else {
//            Log.e("OnRepeatedKey", "::>>>>else vertical scroll...")
        }
        ...
        if (event.action == KeyEvent.ACTION_DOWN) {
            ...
            Log.e("OnRepeatedKey", "::>>>>if (event.action == KeyEvent.ACTION_DOWN)...")
        } else {
            ...
            // in ProgramGrid.
            Log.e("OnRepeatedKey", "::>>>>if (event.action == KeyEvent.ACTION_UP)...")
            isFocusAccelerated = false
        }
