package com.streamly.TVApp.streamly.epg.comedy
...
class ComedyFragment (context: Context): ProgramGuideFragment<ComedyFragment.SimpleProgram>() {
//class EpgFragment (context: Context): ProgramGuideFragment<EpgFragment.SimpleProgram>() {
    ...
    companion object {
        private val TAG = ComedyFragment::class.java.name
    }
