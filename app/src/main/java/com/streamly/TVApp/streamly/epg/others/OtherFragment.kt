package com.streamly.TVApp.streamly.epg.others
...
class OtherFragment(context: Context) : ProgramGuideFragment<OtherFragment.SimpleProgram>() {
//class EpgFragment (context: Context): ProgramGuideFragment<EpgFragment.SimpleProgram>() {
    ...
    companion object {
        private val TAG = OtherFragment::class.java.name
    }
